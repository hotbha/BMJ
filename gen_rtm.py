#!/usr/bin/env python3
"""Generate RTM_MATRIX.md - Requirements Traceability Matrix."""
import os

OUTPUT = "docs/test-cases/RTM_MATRIX.md"

content = r"""# BookMyJuice — Requirements Traceability Matrix (RTM)
...
with open(OUTPUT, "w", encoding="utf-8") as f:
    f.write(content)
print(f"Written RTM matrix to {OUTPUT}")
